...
const debug = require('debug')('app:standingsController');

function standingsController(seasonDictionary) {
    function getStandings(req, res) {
        ...
        (async function mongo() {
            ...
            try {
                ...
                let standings = calculateWinsAndLosses(schedule.schedule, schedule.teams);
